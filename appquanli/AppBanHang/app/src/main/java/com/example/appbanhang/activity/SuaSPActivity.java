...
import com.example.appbanhang.databinding.ActivitySuaSpBinding;
...
public class SuaSPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivitySuaSpBinding.inflate(getLayoutInflater());
    ...
    private void initData() {
        ...
        binding.imgcamera.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ImagePicker.with(SuaSPActivity.this)
